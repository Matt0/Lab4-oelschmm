...
namespace ExpediaTest
{
	...
	public class UserTest
	{
        ...
        public void TestThatUserDoesRemoveCarFromServiceLocatorWhenBooked()
        {
            ...
            Assert.AreSame(remainingC   ar, ServiceLocator.Instance.AvailableCars[0]);
        }
        ...
        {
            ServiceLocator serviceLocator = new ServiceLocator();
            var flightToBook = new Flight(StartDate, EndDate, 5);
            var remainingFlight = new Flight(StartDate, EndDate, 7);
